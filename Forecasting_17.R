...
kheda<-subset(data, District=="KHEDA" &  year!=2017 & year!=2018 & year!=2019 & year!=2020)
anand<-subset(data, District=="ANAND" &  year!=2017 & year!=2018 & year!=2019 & year!=2020)


kheda_2017<-subset(data, District=="KHEDA" & year==2017)
anand_2017<-subset(data, District=="ANAND" & year==2017)
...
########## KHEDA
kheda_tc_ts<-ts(kheda_2017[,"Malaria.cases"], start=c(2017,1), end=c(2017,12), frequency=12)
kheda_pf_ts<-ts(kheda_2017[,"pf"], start=c(2017,1), end=c(2017,12), frequency=12)
kheda_pv_ts<-ts(kheda_2017[,"pv"], start=c(2017,1), end=c(2017,12), frequency=12)
kheda_humidity_ts<-ts(kheda_2017[,"humidity"], start=c(2017,1), end=c(2017,12), frequency=12)
kheda_ave.wind_ts<-ts(kheda_2017[,"ave.wind"], start=c(2017,1), end=c(2017,12), frequency=12)
kheda_rainfall.mm._ts<-ts(kheda_2017[,"rainfall.mm."], start=c(2017,1), end=c(2017,12), frequency=12)
kheda_max_temp_ts<-ts(kheda_2017[,"max_temp"], start=c(2017,1), end=c(2017,12), frequency=12)
kheda_ave_temp_ts<-ts(kheda_2017[,"ave_temp"], start=c(2017,1), end=c(2017,12), frequency=12)
kheda_min_temp_ts<-ts(kheda_2017[,"min_temp"], start=c(2017,1), end=c(2017,12), frequency=12)
...
########## ANAND
anand_tc_ts<-ts(anand_2017[,"Malaria.cases"], start=c(2017,1), end=c(2017,12), frequency=12)
anand_pf_ts<-ts(anand_2017[,"pf"], start=c(2017,1), end=c(2017,12), frequency=12)
anand_pv_ts<-ts(anand_2017[,"pv"], start=c(2017,1), end=c(2017,12), frequency=12)
anand_humidity_ts<-ts(anand_2017[,"humidity"], start=c(2017,1), end=c(2017,12), frequency=12)
anand_ave.wind_ts<-ts(anand_2017[,"ave.wind"], start=c(2017,1), end=c(2017,12), frequency=12)
anand_rainfall.mm._ts<-ts(anand_2017[,"rainfall.mm."], start=c(2017,1), end=c(2017,12), frequency=12)
anand_max_temp_ts<-ts(anand_2017[,"max_temp"], start=c(2017,1), end=c(2017,12), frequency=12)
anand_ave_temp_ts<-ts(anand_2017[,"ave_temp"], start=c(2017,1), end=c(2017,12), frequency=12)
anand_min_temp_ts<-ts(anand_2017[,"min_temp"], start=c(2017,1), end=c(2017,12), frequency=12)
...
##########DATA up to 2008-2016

########## KHEDA
kheda_tc_ts<-ts(kheda[,"Malaria.cases"], start=c(2008,1), end=c(2016,12), frequency=12)
kheda_pf_ts<-ts(kheda[,"pf"], start=c(2008,1), end=c(2016,12), frequency=12)
kheda_pv_ts<-ts(kheda[,"pv"], start=c(2008,1), end=c(2016,12), frequency=12)
kheda_humidity_ts<-ts(kheda[,"humidity"], start=c(2008,1), end=c(2016,12), frequency=12)
kheda_ave.wind_ts<-ts(kheda[,"ave.wind"], start=c(2008,1), end=c(2016,12), frequency=12)
kheda_rainfall.mm._ts<-ts(kheda[,"rainfall.mm."], start=c(2008,1), end=c(2016,12), frequency=12)
kheda_max_temp_ts<-ts(kheda[,"max_temp"], start=c(2008,1), end=c(2016,12), frequency=12)
kheda_ave_temp_ts<-ts(kheda[,"ave_temp"], start=c(2008,1), end=c(2016,12), frequency=12)
kheda_min_temp_ts<-ts(kheda[,"min_temp"], start=c(2008,1), end=c(2016,12), frequency=12)
kheda_2016_ts<-data.frame(kheda_tc_ts, kheda_pf_ts,  kheda_pv_ts,kheda_humidity_ts, kheda_ave.wind_ts, kheda_rainfall.mm._ts, kheda_max_temp_ts, kheda_ave_temp_ts, kheda_min_temp_ts)

##########anand
anand_tc_ts<-ts(anand[,"Malaria.cases"], start=c(2008,1), end=c(2016,12), frequency=12)
anand_pf_ts<-ts(anand[,"pf"], start=c(2008,1), end=c(2016,12), frequency=12)
anand_pv_ts<-ts(anand[,"pv"], start=c(2008,1), end=c(2016,12), frequency=12)
anand_humidity_ts<-ts(anand[,"humidity"], start=c(2008,1), end=c(2016,12), frequency=12)
anand_ave.wind_ts<-ts(anand[,"ave.wind"], start=c(2008,1), end=c(2016,12), frequency=12)
anand_rainfall.mm._ts<-ts(anand[,"rainfall.mm."], start=c(2008,1), end=c(2016,12), frequency=12)
anand_max_temp_ts<-ts(anand[,"max_temp"], start=c(2008,1), end=c(2016,12), frequency=12)
anand_ave_temp_ts<-ts(anand[,"ave_temp"], start=c(2008,1), end=c(2016,12), frequency=12)
anand_min_temp_ts<-ts(anand[,"min_temp"], start=c(2008,1), end=c(2016,12), frequency=12)
anand_2016_ts<-data.frame(anand_tc_ts, anand_pf_ts,anand_pv_ts, anand_humidity_ts, anand_ave.wind_ts, anand_rainfall.mm._ts, anand_max_temp_ts, anand_ave_temp_ts, anand_min_temp_ts)
...
fit.model_kheda_pv <- tslm(kheda_pv_ts~kheda_humidity_ts+kheda_rainfall.mm._ts+kheda_min_temp_ts, data=kheda_2016_ts)
fit.model_anand_pv <- tslm(anand_pv_ts~anand_humidity_ts+anand_rainfall.mm._ts+anand_min_temp_ts, data=anand_2016_ts)

fit.model_kheda_pf <- tslm(kheda_pf_ts~kheda_humidity_ts+kheda_rainfall.mm._ts+kheda_min_temp_ts, data=kheda_2016_ts)
fit.model_anand_pf <- tslm(anand_pf_ts~anand_humidity_ts+anand_rainfall.mm._ts+anand_min_temp_ts, data=anand_2016_ts)

fit.model_kheda_tc <- tslm(kheda_tc_ts~kheda_humidity_ts+kheda_rainfall.mm._ts+kheda_min_temp_ts, data=kheda_2016_ts)
fit.model_anand_tc <- tslm(anand_tc_ts~anand_humidity_ts+anand_rainfall.mm._ts+anand_min_temp_ts, data=anand_2016_ts)
...
fcast_kheda_pv = forecast(fit.model_kheda_pv, h=12, newdata=kheda_2017_ts) 
fcast_anand_pv = forecast(fit.model_anand_pv, h=12, newdata=anand_2017_ts) 

fcast_kheda_pf = forecast(fit.model_kheda_pf, h=12, newdata=kheda_2017_ts) 
fcast_anand_pf = forecast(fit.model_anand_pf, h=12, newdata=anand_2017_ts) 

fcast_kheda_tc = forecast(fit.model_kheda_tc, h=12, newdata=kheda_2017_ts) 
fcast_anand_tc = forecast(fit.model_anand_tc, h=12, newdata=anand_2017_ts) 
...
fit.model_S_T_kheda_pv <- tslm(kheda_pv_ts~kheda_humidity_ts+kheda_rainfall.mm._ts+kheda_min_temp_ts+trend+season, data=kheda_2016_ts)
fit.model_S_T_anand_pv <- tslm(anand_pv_ts~anand_humidity_ts+anand_rainfall.mm._ts+anand_min_temp_ts+trend+season, data=anand_2016_ts)

fit.model_S_T_kheda_pf <- tslm(kheda_pf_ts~kheda_humidity_ts+kheda_rainfall.mm._ts+kheda_min_temp_ts+trend+season, data=kheda_2016_ts)
fit.model_S_T_anand_pf <- tslm(anand_pf_ts~anand_humidity_ts+anand_rainfall.mm._ts+anand_min_temp_ts+trend+season, data=anand_2016_ts)

fit.model_S_T_kheda_tc <- tslm(kheda_tc_ts~kheda_humidity_ts+kheda_rainfall.mm._ts+kheda_min_temp_ts+trend+season, data=kheda_2016_ts)
fit.model_S_T_anand_tc <- tslm(anand_tc_ts~anand_humidity_ts+anand_rainfall.mm._ts+anand_min_temp_ts+trend+season, data=anand_2016_ts)


fcast_S_T_kheda_pv = forecast(fit.model_S_T_kheda_pv, h=12, newdata=kheda_2017_ts) 
fcast_S_T_anand_pv = forecast(fit.model_S_T_anand_pv, h=12, newdata=anand_2017_ts) 

fcast_S_T_kheda_pf = forecast(fit.model_S_T_kheda_pf, h=12, newdata=kheda_2017_ts) 
fcast_S_T_anand_pf = forecast(fit.model_S_T_anand_pf, h=12, newdata=anand_2017_ts) 

fcast_S_T_kheda_tc = forecast(fit.model_S_T_kheda_tc, h=12, newdata=kheda_2017_ts) 
fcast_S_T_anand_tc = forecast(fit.model_S_T_anand_tc, h=12, newdata=anand_2017_ts) 
...
model_hw_kheda_pv<-HoltWinters(kheda_2016_ts$kheda_pv_ts)
model_hw_anand_pv<-HoltWinters(anand_2016_ts$anand_pv_ts)

model_hw_kheda_pf<-HoltWinters(kheda_2016_ts$kheda_pf_ts)
model_hw_anand_pf<-HoltWinters(anand_2016_ts$anand_pf_ts)

model_hw_kheda_tc<-HoltWinters(kheda_2016_ts$kheda_tc_ts)
model_hw_anand_tc<-HoltWinters(anand_2016_ts$anand_tc_ts)
...
##########pv
model_ARIMA_kheda_aic_pv<-auto.arima(kheda_2016_ts$kheda_pv_ts, trace = TRUE, test="kpss", ic="aic")
model_ARIMA_kheda_bic_pv<-auto.arima(kheda_2016_ts$kheda_pv_ts, trace = TRUE, test="kpss", ic="bic")
model_ARIMA_kheda_log_aic_pv<-auto.arima(log(kheda_2016_ts$kheda_pv_ts+1), trace = TRUE, test="kpss", ic="aic")
model_ARIMA_kheda_log_bic_pv<-auto.arima(log(kheda_2016_ts$kheda_pv_ts+1), trace = TRUE, test="kpss", ic="bic")
...
##########pF
model_ARIMA_kheda_aic_pf<-auto.arima(kheda_2016_ts$kheda_pf_ts, trace = TRUE, test="kpss", ic="aic")
model_ARIMA_kheda_bic_pf<-auto.arima(kheda_2016_ts$kheda_pf_ts, trace = TRUE, test="kpss", ic="bic")
model_ARIMA_kheda_log_aic_pf<-auto.arima(log(kheda_2016_ts$kheda_pf_ts+1), trace = TRUE, test="kpss", ic="aic")
model_ARIMA_kheda_log_bic_pf<-auto.arima(log(kheda_2016_ts$kheda_pf_ts+1), trace = TRUE, test="kpss", ic="bic")
...
##########TOTAL
model_ARIMA_kheda_aic_tc<-auto.arima(kheda_2016_ts$kheda_tc_ts, trace = TRUE, test="kpss", ic="aic")
model_ARIMA_kheda_bic_tc<-auto.arima(kheda_2016_ts$kheda_tc_ts, trace = TRUE, test="kpss", ic="bic")
model_ARIMA_kheda_log_aic_tc<-auto.arima(log(kheda_2016_ts$kheda_tc_ts+1), trace = TRUE, test="kpss", ic="aic")
model_ARIMA_kheda_log_bic_tc<-auto.arima(log(kheda_2016_ts$kheda_tc_ts+1), trace = TRUE, test="kpss", ic="bic")
...
##########pv
model_ARIMA_anand_aic_pv<-auto.arima(anand_2016_ts$anand_pv_ts, trace = TRUE, test="kpss", ic="aic")
model_ARIMA_anand_bic_pv<-auto.arima(anand_2016_ts$anand_pv_ts, trace = TRUE, test="kpss", ic="bic")
model_ARIMA_anand_log_aic_pv<-auto.arima(log(anand_2016_ts$anand_pv_ts+1), trace = TRUE, test="kpss", ic="aic")
model_ARIMA_anand_log_bic_pv<-auto.arima(log(anand_2016_ts$anand_pv_ts+1), trace = TRUE, test="kpss", ic="bic")
...
##########pf
model_ARIMA_anand_aic_pf<-auto.arima(anand_2016_ts$anand_pf_ts, trace = TRUE, test="kpss", ic="aic")
model_ARIMA_anand_bic_pf<-auto.arima(anand_2016_ts$anand_pf_ts, trace = TRUE, test="kpss", ic="bic")
model_ARIMA_anand_log_aic_pf<-auto.arima(log(anand_2016_ts$anand_pf_ts+1), trace = TRUE, test="kpss", ic="aic")
model_ARIMA_anand_log_bic_pf<-auto.arima(log(anand_2016_ts$anand_pf_ts+1), trace = TRUE, test="kpss", ic="bic")
...
##########Total
model_ARIMA_anand_aic_tc<-auto.arima(anand_2016_ts$anand_tc_ts, trace = TRUE, test="kpss", ic="aic")
model_ARIMA_anand_bic_tc<-auto.arima(anand_2016_ts$anand_tc_ts, trace = TRUE, test="kpss", ic="bic")
model_ARIMA_anand_log_aic_tc<-auto.arima(log(anand_2016_ts$anand_tc_ts+1), trace = TRUE, test="kpss", ic="aic")
model_ARIMA_anand_log_bic_tc<-auto.arima(log(anand_2016_ts$anand_tc_ts+1), trace = TRUE, test="kpss", ic="bic")
...
xreg_kheda<-cbind(kheda_2016_ts[, 4], kheda_2016_ts[, 6], kheda_2016_ts[, 9])
xreg_anand<-cbind(anand_2016_ts[, 4], anand_2016_ts[, 6], anand_2016_ts[, 9])


xreg_kheda_2017<-cbind(kheda_2017_ts[, 4], kheda_2017_ts[, 6], kheda_2017_ts[, 9])
xreg_anand_2017<-cbind(anand_2017_ts[, 4], anand_2017_ts[, 6], anand_2017_ts[, 9])


model_ARIMA_Reg_kheda_pv<-auto.arima(kheda_2016_ts[,"kheda_pv_ts"], xreg=xreg_kheda)
model_ARIMA_Reg_anand_pv<-auto.arima(anand_2016_ts[,"anand_pv_ts"], xreg=xreg_anand)



model_ARIMA_Reg_kheda_pf<-auto.arima(kheda_2016_ts[,"kheda_pf_ts"], xreg=xreg_kheda)
model_ARIMA_Reg_anand_pf<-auto.arima(anand_2016_ts[,"anand_pf_ts"], xreg=xreg_anand)


model_ARIMA_Reg_kheda_tc<-auto.arima(kheda_2016_ts[,"kheda_tc_ts"], xreg=xreg_kheda)
model_ARIMA_Reg_anand_tc<-auto.arima(anand_2016_ts[,"anand_tc_ts"], xreg=xreg_anand)


fcast_reg_kheda_pv = forecast(model_ARIMA_Reg_kheda_pv, h=12, xreg=xreg_kheda_2017) 
fcast_reg_kheda_pf = forecast(model_ARIMA_Reg_kheda_pf, h=12, xreg=xreg_kheda_2017) 
fcast_reg_kheda_tc = forecast(model_ARIMA_Reg_kheda_tc, h=12, xreg=xreg_kheda_2017) 

fcast_reg_anand_pv = forecast(model_ARIMA_Reg_anand_pv, h=12, xreg=xreg_anand_2017) 
fcast_reg_anand_pf = forecast(model_ARIMA_Reg_anand_pf, h=12, xreg=xreg_anand_2017) 
fcast_reg_anand_tc = forecast(model_ARIMA_Reg_anand_tc, h=12, xreg=xreg_anand_2017) 
...
final_kheda_pv<-data.frame(kheda_2017_ts$kheda_pv_ts,TC_Reg_kheda_pv, TC_Reg_trend_kheda_pv, HW_kheda_pv, ARIMA_AIC_kheda_pv, ARIMA_BIC_kheda_pv, ARIMA_LOG_AIC_kheda_pv, ARIMA_LOG_BIC_kheda_pv, ARIMA_REG_kheda_pv)
final_kheda_pf<-data.frame(kheda_2017_ts$kheda_pf_ts,TC_Reg_kheda_pf, TC_Reg_trend_kheda_pf, HW_kheda_pf, ARIMA_AIC_kheda_pf, ARIMA_BIC_kheda_pf, ARIMA_LOG_AIC_kheda_pf, ARIMA_LOG_BIC_kheda_pf, ARIMA_REG_kheda_pf)
final_kheda_tc<-data.frame(kheda_2017_ts$kheda_tc_ts,TC_Reg_kheda_tc, TC_Reg_trend_kheda_tc, HW_kheda_tc, ARIMA_AIC_kheda_tc, ARIMA_BIC_kheda_tc, ARIMA_LOG_AIC_kheda_tc, ARIMA_LOG_BIC_kheda_tc, ARIMA_REG_kheda_tc)

final_anand_pv<-data.frame(anand_2017_ts$anand_pv_ts,TC_Reg_anand_pv, TC_Reg_trend_anand_pv, HW_anand_pv, ARIMA_AIC_anand_pv, ARIMA_BIC_anand_pv, ARIMA_LOG_AIC_anand_pv, ARIMA_LOG_BIC_anand_pv, ARIMA_REG_anand_pv)
final_anand_pf<-data.frame(anand_2017_ts$anand_pf_ts,TC_Reg_anand_pf, TC_Reg_trend_anand_pf, HW_anand_pf, ARIMA_AIC_anand_pf, ARIMA_BIC_anand_pf, ARIMA_LOG_AIC_anand_pf, ARIMA_LOG_BIC_anand_pf, ARIMA_REG_anand_pf)
final_anand_tc<-data.frame(anand_2017_ts$anand_tc_ts,TC_Reg_anand_tc, TC_Reg_trend_anand_tc, HW_anand_tc, ARIMA_AIC_anand_tc, ARIMA_BIC_anand_tc, ARIMA_LOG_AIC_anand_tc, ARIMA_LOG_BIC_anand_tc, ARIMA_REG_anand_tc)
...
ggseasonplot(kheda_pv_ts, year.labels=F, xlab="Months", ylab="Pv Cases",  main="",polar = TRUE, col=rainbow(9))+geom_line( size=1)+ theme_minimal()+ theme( legend.position="NULL", axis.text= element_text(size=12, face="bold", family = 2),axis.title = element_text(face="bold", size=15, family=3),axis.title.x=element_blank(), panel.grid.major = element_line(size = .5, linetype = "dashed",colour = "black"))
ggseasonplot(kheda_pf_ts, year.labels=F  , xlab="Months", ylab="Pf Cases",  main="",polar = TRUE, col=rainbow(9))+geom_line( size=1)+ theme_minimal()+ theme( legend.position="NULL", axis.text= element_text(size=12, face="bold", family = 2),axis.title = element_text(face="bold", size=15, family=3),axis.title.x=element_blank(), panel.grid.major = element_line(size = .5, linetype = "dashed",colour = "black"))
ggseasonplot(kheda_rainfall.mm._ts, year.labels=F  , xlab="Months", ylab="Rainfall (MM)",  main="",polar = TRUE, col=rainbow(9))+geom_line( size=1)+ theme_minimal()+ theme( legend.position="NULL",axis.text= element_text(size=12, face="bold", family = 2),axis.title = element_text(face="bold", size=15, family=3),axis.title.x=element_blank(), panel.grid.major = element_line(size = .5, linetype = "dashed",colour = "black"))
ggseasonplot(kheda_humidity_ts, year.labels=F  , xlab="Months", ylab="Humidity (%)",  main="",polar = TRUE, col=rainbow(9))+geom_line( size=1)+ theme_minimal()+ theme(legend.position="NULL", axis.text= element_text(size=12, face="bold", family = 2),axis.title = element_text(face="bold", size=15, family=3),axis.title.x=element_blank(), panel.grid.major = element_line(size = .5, linetype = "dashed",colour = "black"))
ggseasonplot(kheda_min_temp_ts, year.labels=F  , xlab="Months", ylab="Min. Temp. (C)",  main="",polar = TRUE, col=rainbow(9))+theme_minimal()+geom_line( size=1)+ theme_minimal()+ theme(legend.position="NULL", axis.text= element_text(size=12, face="bold", family = 2),axis.title = element_text(face="bold", size=15, family=3),axis.title.x=element_blank(), panel.grid.major = element_line(size = .5, linetype = "dashed",colour = "black"))
...
ggseasonplot(anand_pv_ts, year.labels=F, xlab="Months", ylab="Pv Cases",  main="",polar = TRUE, col=rainbow(9))+geom_line( size=1)+ theme_minimal()+ theme( legend.position="NULL", axis.text= element_text(size=12, face="bold", family = 2),axis.title = element_text(face="bold", size=15, family=3),axis.title.x=element_blank(), panel.grid.major = element_line(size = .5, linetype = "dashed",colour = "black"))
ggseasonplot(anand_pf_ts, year.labels=F  , xlab="Months", ylab="Pf Cases",  main="",polar = TRUE, col=rainbow(9))+geom_line( size=1)+ theme_minimal()+ theme( legend.position="NULL", axis.text= element_text(size=12, face="bold", family = 2),axis.title = element_text(face="bold", size=15, family=3),axis.title.x=element_blank(), panel.grid.major = element_line(size = .5, linetype = "dashed",colour = "black"))
ggseasonplot(anand_rainfall.mm._ts, year.labels=F  , xlab="Months", ylab="Rainfall (MM)",  main="",polar = TRUE, col=rainbow(9))+geom_line( size=1)+ theme_minimal()+ theme( legend.position="NULL",axis.text= element_text(size=12, face="bold", family = 2),axis.title = element_text(face="bold", size=15, family=3),axis.title.x=element_blank(), panel.grid.major = element_line(size = .5, linetype = "dashed",colour = "black"))
ggseasonplot(anand_humidity_ts, year.labels=F  , xlab="Months", ylab="Humidity (%)",  main="",polar = TRUE, col=rainbow(9))+geom_line( size=1)+ theme_minimal()+ theme(legend.position="NULL", axis.text= element_text(size=12, face="bold", family = 2),axis.title = element_text(face="bold", size=15, family=3),axis.title.x=element_blank(), panel.grid.major = element_line(size = .5, linetype = "dashed",colour = "black"))
ggseasonplot(anand_min_temp_ts, year.labels=F  , xlab="Months", ylab="Min. Temp. (C)",  main="",polar = TRUE, col=rainbow(9))+theme_minimal()+geom_line( size=1)+ theme_minimal()+ theme(legend.position="NULL", axis.text= element_text(size=12, face="bold", family = 2),axis.title = element_text(face="bold", size=15, family=3),axis.title.x=element_blank(), panel.grid.major = element_line(size = .5, linetype = "dashed",colour = "black"))
